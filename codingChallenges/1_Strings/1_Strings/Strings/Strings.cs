    ...
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            //string fName = userInputString;
            //string lName = userInputString;
            //string x = "";
        ...
        public static string StringSubstring(string x, int firstElement, int lengthOfSubsring)
        {
            ...
            //int firstString = x.IndexOf();
            string substringEx = x.Substring(firstElement, lengthOfSubsring);
            return substringEx;
